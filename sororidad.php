      ...
      <div class="row">
        <div class="grid_12">
          <div class="heading1 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
            <h2>Mujeres en Sororidad</h2>
          </div>
          <br>
           <br>

           <h2><span class="light">"La alianza de las mujeres en el compromiso es tan importante como la lucha contra otros fenómenos de la opresión y por crear espacios en que las mujeres puedan desplegar nuevas posibilidades de vida". Marcela Lagarde </span></h2>
<br>
            <h2><span class="light">La sororidad está basada en una relación de amistad, pues en las amigas las mujeres encontramos a una mujer de la cual aprendemos y a la que también podemos enseñar, es decir, a una persona a quien se acompaña y con quien se construye. 
</span></h2>
                  </h2>
                  <br>
<h2><span class="light">Este programa está diseñado para formar grupos de mujeres donde aprendamos a ser camaradas, estar dispuestas a la ayuda, en la que no cabe ningún sentimiento negativo como la envidia, la competencia encarnizada o la rivalidad , en donde nos reinventemos como mujeres.</span></h2>
                  </h2>
                </div>
        </div>
      </div>
