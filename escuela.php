      ...
      <div class="row">
        <div class="grid_12">
          <div class="heading1 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
            <h2>Escuela Modelo de Igualdad</h2>
          </div>
          <br>
           <br>

           <h2><span class="light">La Escuela Modelo de Igualdad, busca reinventar la forma de relacionarnos hombres y mujeres dentro y fuera del plantel educativo, donde podamos vernos a los ojos y reconocer que somos iguales y tenemos los mismos derechos y obligaciones. </span></h2>
<br>
            <h2><span class="light">El propósito de la EMI es fomentar en los niños y las niñas una cultura de igualdad y justicia social, así como eliminar la violencia contra las mujeres.</span></h2>
                  </h2>
                  <br>
<h2><span class="light">El desarrollo de este modelo, llevará a la apertura y transformación de nuevas prácticas educativas y de la forma en que se relacionarán los niños y las niñas, con maestros y maestras y padres y madres de familia.</span></h2>
                  </h2>
<br>
<h2><span class="light">El plan piloto se lleva a cabo en la Escuela Jesús Reyes Heroles, donde es Director el Profesor Ramiro Banda.</span></h2>
                  </h2>
          </div>
        </div>
      </div>
