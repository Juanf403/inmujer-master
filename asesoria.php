      ...
      <div class="row">
       ...
       <div class="row">
        <div class="grid_12">
           ...
           <h2><span class="light">Proporcionar orientación a las mujeres violentadas, sobre sus derechos, las características de los procesos judiciales y las opciones legales, estos servicios incluyen, información, asesoría, acompañamiento y representación jurídica de las mujeres ante cualquier instancia del ámbito judicial.  </span></h2></a>
           <br>
           <h2><span class="light">La atención jurídica tiene como prioridad promover el acceso a la justicia salvaguardando la seguridad y derechos de las mujeres así como el de sus hijas e hijos de posibles agresiones por parte de su agresor, fortalecer las medidas personales, para evitar la repetición de la violencia. </span></h2></a>
           <br>
           <h2><span class="light">Asesoramos en casos de: divorcio, denuncias penales, obtención de custodia de los hijos (as), obtención de pensión alimenticia, obtención de apellido paterno para los hijos(as) de madres solteras a través de la Ley de Paternidad Responsable en Tamaulipas.</span></h2></a>
