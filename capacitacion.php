      ...
      <div class="row">
        <div class="grid_12">
          <div class="heading1 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
            <h2>Capacitacion de Integrantes del Cabildo; Diputadas y Diputados</h2>
          </div>
          <div class="row">
        <div class="grid_12">
<br>
           ...
           <h2><span class="light">Concientizar y sensibilizar a los funcionarios que ocupan puestos de elección popular, sobre la igualdad de género y los derechos de las mujeres con la finalidad de capacitarlos en la implementación de políticas públicas a favor de las mujeres.</span></h2></a>
           <br>
<h2><span>Talleres a funcionarios municipales </span></h2></a>
           <h2><span class="light">Concientizar y sensibilizar a los funcionarios públicos municipales, sobre la igualdad de género y de oportunidades para hombres y mujeres con la finalidad de mejorar el trato que reciben las usuarias del servicio público. </span></h2></a>
           <br>
<h2><span class="light">Otra razón fundamental de estos cursos es porque los servidores públicos son quienes elaboran y ejecutan los Planes, Proyectos, Programas, Presupuestos y Políticas Públicas y éstos, por ley, no deben estar sesgadas hacia el género masculino o afectar las oportunidades y/o derechos de las mujeres.</span></h2></a>
          </div>
        </div>
      </div>
