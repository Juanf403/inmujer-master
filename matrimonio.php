      ...
      <div class="row">
        <div class="grid_12">
          <div class="heading1 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
            <h2>Igualdad en el Matrimomnio</h2>
          </div>
          <br>
           <br>

           <h2><span class="light">De acuerdo al Código Civil de Tamaulipas las parejas que deseen contraer matrimonio deberán recibir pláticas en el Instituto Municipal de la Mujer, estas pláticas están enfocadas a informar a las parejas los tipos de violencia y los derechos de las mujeres. </span></h2>
<br>
            <h2><span class="light">Se llevan a cabo los días lunes, miércoles y viernes con dos horarios a las 13:00 y 18:00 horas.</span></h2>
                  </h2>
                  <br>
<h2><span class="light">A las parejas que acuden se les entrega su constancia para cumplir con el requisito que establece la ley.</span></h2>
                  </h2>
