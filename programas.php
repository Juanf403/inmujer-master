      ...
      <div class="row">
       ...
       <div class="row">
        <div class="grid_12">
          ...
          <br>
          <h2><a href="atencion.php"><span class="light"> Atención Psicológica</span></h2></a>
                  </h2>
          <br>
          <h2><a href="asesoria.php"><span class="light"> Asesoria Legal</span></h2></a>
                  </h2>
         <br>
         <h2><a href="igualdad.php"><span class="light"> Igualdad en la Escuela</span></h2></a>
                  </h2>
          <br>
          <h2><a href="colonias.php"><span class="light">Mujeres en Colonias</span></h2></a>
                  </h2>
          <br>
          <h2><a href="matrimonio.php"><span class="light">Igualdad en el Matrimonio</span></h2></a>
                  </h2>
          <br>
          <h2><a href="sororidad.php"><span class="light">Mujeres en Sororidad</span></h2></a>
                  </h2>
          <br>
          <h2><a href="escuela.php"><span class="light">Escuela Modelo de Igualdad</span></h2></a>
                  </h2>
          <br>
          <h2><a href="capacitacion.php"><span class="light">Capacitación Cabildo, Diputadas y Diputados</span></h2></a>
