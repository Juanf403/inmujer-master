      ...
      <div class="row">
        <div class="grid_12">
          <div class="heading1 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
            <h2>Igualdad en la Escuela</h2>
          </div>
          
           <br>
           <br>

           <h2><span class="light">Las aulas deben ser un espacio de construcción de una nueva ciudadanía. 
Debemos transformar el salón de clases en un lugar donde se reinventen las formas en que se relacionan mujeres y hombres. 
La finalidad de estas pláticas es que inicien una vida más justa, armoniosa y equitativa, libre de violencia de género.</span></h2>
                  </h2>
          </div>
        </div>
      </div>
